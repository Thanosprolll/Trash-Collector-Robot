...
Vào device manager tìm COM có trong driver ví dụ COM4, COM5
Mở Python code và chỉnh đúng COM của HC-06 trên config
Khởi động code, cài python -m pip install pyserial nếu báo lỗi
Connect ở 9600 baud rate.
